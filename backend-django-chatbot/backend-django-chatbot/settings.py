"""
Django settings for backend-django-chatbot project.
...
SECRET_KEY = 'django-insecure-keh1jb^roen-sl&=-5=c$5fq2*isi0tfe*=#^=p9+(yh-x=@xt'
...
ROOT_URLCONF = 'backend-django-chatbot.urls'
...
WSGI_APPLICATION = 'backend-django-chatbot.wsgi.application'
